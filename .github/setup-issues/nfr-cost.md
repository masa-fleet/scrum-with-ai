...
- [ ] [CO:07](https://learn.microsoft.com/ja-jp/azure/well-architected/cost-optimization/optimize-component-costs) 不要・重複・低使用率の機能やリソースを定期的に見直し、削除または縮小する方針が定義されている
