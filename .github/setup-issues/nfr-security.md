...
- [ ] [SE:03](https://learn.microsoft.com/ja-jp/azure/well-architected/security/data-classification) データ分類（例: 公開・社内限定・機密・個人情報）と、分類ごとの取り扱い方針が定義されている
- [ ] [SE:04](https://learn.microsoft.com/ja-jp/azure/well-architected/security/segmentation) / [SE:06](https://learn.microsoft.com/ja-jp/azure/well-architected/security/networking) ネットワーク・ID・リソースの分離境界と、受信・送信通信の制御方針が定義されている
