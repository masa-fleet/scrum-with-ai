...
特に AI/DS を含むプロジェクトでは、精度指標や評価方法の合意が遅れるとスプリント終盤で手戻りが発生しやすいため、ADS 中に TPM、Dev Lead、DS Lead が揃って定義し、お客様と合意することが重要。
...
- FDE はお客様のビジネス課題を解決することが主眼であるため、測定可能なビジネス KPI（例: 売上改善率、コスト削減額、オペレーション工数削減 %）も定義する。
