...
- [ ] [OE:01](https://learn.microsoft.com/ja-jp/azure/well-architected/operational-excellence/devops-culture) 開発・運用における役割、責任、意思決定者が明確になっている
- [ ] [OE:02](https://learn.microsoft.com/ja-jp/azure/well-architected/operational-excellence/formalize-operations-tasks) 定常作業・臨時作業・緊急作業の運用手順が標準化されている
...
- [ ] [OE:05](https://learn.microsoft.com/ja-jp/azure/well-architected/operational-excellence/infrastructure-as-code-design) IaC の対象範囲、使用ツール、構成管理・レビュー方針が決定されている
- [ ] [OE:06](https://learn.microsoft.com/ja-jp/azure/well-architected/operational-excellence/workload-supply-chain) CI/CD パイプラインの対象環境、テスト、承認、品質ゲートが定義されている
